...
export default class BusinessModel {
  ...
  : `SELECT category, COUNT(*) AS total_listings FROM business_detail GROUP BY category`;
    ...
    static async addBusinessDetails(businessName,  address, category, phone, latitude, longitude, website, userId) {
        console.log('inside addBusinessDetails');
        console.log({ businessName, address, category, phone, latitude, longitude, website, userId });
