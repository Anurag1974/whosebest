...
export default class BusinessModel {
  ...
  : `SELECT category, COUNT(*) AS total_listings FROM business_detail GROUP BY category`;
    ...
    //add new business 
    static async addBusinessDetails(businessName,  address, category, phone, latitude, longitude, website, userId,state,city) {
        console.log('inside addBusinessDetails');
        console.log({ businessName, address, category, phone, latitude, longitude, website, userId,state,city});
    
        const [result] = await db.execute(
            'INSERT INTO business_detail (business_name,address, category, phone, latitude, longitude, website, user_id,state,city) VALUES (?,?,?,?,?,?,?,?,?,?)',
            [businessName, address, category, phone, latitude, longitude, website, userId,state,city]
        );
